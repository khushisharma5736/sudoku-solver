"""
This is the ENTRY POINT of the Sudoku Solver mini-project. It simply creates the main Tkinter window and hands control over tothe SudokuGUI class defined in gui.py, which builds the actual board and buttons.
"""
